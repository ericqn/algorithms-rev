...
class BST:
    ...
    def insert(self, value, curr_node:BST_Node=None):
        """BST Node insertion algorithm"""
        if not curr_node:
...
if __name__ == '__main__':
    ...
    bst = BST(4)
    bst.insert(3, curr_node=bst.root)
    bst.insert(5, curr_node=bst.root)
    bst.insert(1, curr_node=bst.root)
    # print(bst.root.left)
